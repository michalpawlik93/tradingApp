...
namespace TradingApp.Module.Quotes.Evaluator.Test.Indicators
{
    public class MoneyFlowIndicatorTests : QuotesTestBase
    {
        ...
        public void Calculate_With_Custom_Quotes()
        {
            ...
            {
                new(DateTime.Parse("2024-05-01"), 100, 110, 90, 105, 10000),
                new(DateTime.Parse("2024-05-02"), 105, 115, 95, 110, 12000),
                new(DateTime.Parse("2024-05-03"), 110, 120, 100, 115, 8000),
                new(DateTime.Parse("2024-05-04"), 115, 125, 105, 120, 7000),
                new(DateTime.Parse("2024-05-05"), 120, 130, 110, 125, 6000),
                new(DateTime.Parse("2024-05-06"), 125, 135, 115, 130, 5000),
                new(DateTime.Parse("2024-05-07"), 130, 140, 120, 135, 4000),
                new(DateTime.Parse("2024-05-08"), 135, 145, 125, 140, 3000),
                new(DateTime.Parse("2024-05-09"), 140, 150, 130, 145, 2000),
        ...
        private static Quote DivideByNullScenario => new(DateTime.Parse("2024-05-10"), 145, 155, 155, 150, 1000);
    }
}
